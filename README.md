...
Finishing up my CS degree at [URJC](https://www.urjc.es/) in Madrid. Alongside that I spent 
...
- **Multi-agent LLM systems** — I'm building a financial market analysis pipeline 
  ...
  but happy to nerd out about the architecture.
- **Computer vision in production** — YOLO models, Azure ML, and the fun engineering 
  challenges that come from real CCTV footage (spoiler: headlights at night are chaos).
